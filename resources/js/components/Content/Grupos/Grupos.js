    ...
    this.state.grupos.map(grupo => {
        return (
            <tr>
                ...
                <td><button className="btn btn-danger"  onClick={this.onDelete.bind(this,grupo.id)}><FontAwesomeIcon icon="trash-alt" /></button></td> 
                <td><button className="btn btn-info"  onClick={this.toggleModal.bind(this, grupo.id)}><FontAwesomeIcon icon="info-circle" /></button></td> 
